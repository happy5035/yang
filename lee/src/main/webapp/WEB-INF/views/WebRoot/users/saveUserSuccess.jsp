    ...
    cellspacing="0" cellpadding="0" height="27">
        <tr>
          ...
          <td width="47%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
                <tr>
					<td width="100%" class="f3">用户信息管理>>添加用户信息成功</td>
                </tr>
            </table></td>
          <td width="50%"></td>
        </tr>
	...
	<tr>
		<td align="center" class="tr4"> 
			<table border="0" cellpadding="3" cellspacing="1" class="table3">
				<tr class="tr2">
					<td  class="tr1" align="center">添加用户信息成功！</td>
				</tr>
			</table>
		</td>
    </tr>
    <tr>
		<td align="center" class="tr4"><a href="addUser.action">返回</a></td> 
	</tr>
</table>
</form> 
</body>
