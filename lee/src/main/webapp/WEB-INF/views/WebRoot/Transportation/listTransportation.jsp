      ...
      <table width="800" cellspacing="1" border="0" class="table1" height="95">
       ...
       <c:forEach var="item" items="${Pagelist}" varStatus="status">
        	<tr class="tr2" align="center">
	        	...
	        	<td>${item.note}</td>                
	    		<td><a href="EditTrsport.action?transId=${item.transId}">修改</a></td>
	    		<td><a href="DeleteTrsport.action?transId=${item.transId}&busNumber=${busNumber}&transNo=${transNo}&tranModelId=${tranModelId}">删除</a></td>	
	    	</tr>
		</c:forEach>
      </table>    
    </td>
